...
public class JogaGolsAdapter extends BaseAdapter {
    LayoutInflater inflater;
    List<Jogador> jogaTemp;

    public JogaGolsAdapter(List<Jogador> jogaTemp, Context ctx){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtNum.setText(Integer.toString(joga.getContGols()));
